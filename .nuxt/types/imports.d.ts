...
export {}
declare global {
  const PERSONAS: typeof import('../../stores/user').PERSONAS
...
declare global {
  ...
  // @ts-ignore
  export type { Lesson, QuizQuestion, Module, Course } from '../../stores/courses'
  import('../../stores/courses')
  // @ts-ignore
  export type { Persona } from '../../stores/user'
  import('../../stores/user')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly PERSONAS: UnwrapRef<typeof import('../../stores/user')['PERSONAS']>
